...
class MaskRCNN():
    ...
    def mold_inputs(self, images):
        ...
        print("my image_metas:" , image_metas,"//")
    ...
    def detect(self, images, verbose=0):
        ...
        #self.keras_model.save('seat_model.h5')
        # Process detections
        """
        print(detections[0][0])
        print(detections[0].shape)
        print(type(detections[0]), detections[0].dtype)

        print(mrcnn_mask[0][0])
        print(mrcnn_mask[0].shape)
        print(type(mrcnn_mask[0]), mrcnn_mask[0].dtype)        
        """
        results = []
