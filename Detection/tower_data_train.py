...
from tower_data_config import TowerDataConfig, TowerDataset, InferenceConfig
...
def model_train_evaluate(dataset_train_dir, dataset_eval_dir,
    ...
    image_ids = [61,71,81]#np.random.choice(dataset_train.image_ids, 2)
