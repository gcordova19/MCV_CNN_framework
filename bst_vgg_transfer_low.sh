...
python3 main.py --exp_name VGG16_TransferTT100K_${SLURM_JOB_ID} --exp_folder BelgiumTSC --config_file config/classification_sample_vgg16_bst_transferTT100K.yml
